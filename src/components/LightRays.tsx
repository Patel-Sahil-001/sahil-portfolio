...
import { Renderer, Program, Triangle, Mesh, Vec2, Vec3 } from 'ogl';
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // Adjust brightness/color distribution slightly if needed
...
void main() {
  ...
  gl_FragColor  = color;
            ...
            const uniforms = {
                ...
                raysColor: { value: new Vec3(...hexToRgb(raysColor)) },
            ...
            cleanupFunctionRef.current = () => {
                ...
                if (renderer) {
                    try {
                        ...
                        // Trying to lose context to free memory if possible
    ...
    useEffect(() => {
        ...
        u.raysColor.value.set(...hexToRgb(raysColor));
    ...
    useEffect(() => {
        const handleMouseMove = (e: MouseEvent) => {
            ...
            mouseRef.current = { x, y }; // Invert Y is handled in shader
        };
