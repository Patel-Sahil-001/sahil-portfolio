        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass rounded-2xl p-8 glow-cyan">
              ...
              <p className="text-lg leading-relaxed text-foreground/90 mb-4">
                My journey in tech is driven by a unique blend of <span className="text-neon-cyan">problem-solving prowess</span> and 
                <span className="text-neon-purple"> creative design thinking</span>. I specialize in Java and Python development, 
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                className="glass rounded-xl p-6 hover:glow-purple transition-all duration-300 group"
              >
